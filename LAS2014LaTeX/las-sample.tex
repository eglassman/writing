...
\title{Principles for Tools Supporting Engineering Design Challenges at Scale}
...
\begin{abstract}
Peer-instruction, peer-reviewing, and more recently learner-sourcing can help students learn, especially when the student-to-staff ratio is high. We describe three deployed learner-sourcing scenarios within the context of an undergraduate digital design class. The key design principle is students should be directed to hints written by other students who have just completed the task themselves. Initial results are promising, and warrant follow-up work.
\end{abstract}
...
\section{Dear Beta: Optimization Edition}
\subsection{Description}
\subsection{Design Challenges}
\begin{itemize}
\item shorter spaces between check-ins with sheet
\item automated population of fields/calculation of change in benmark (less lowfi)
\item no enough incentive to participate
\item lacks debugging tips as well (perhaps just as plentiful)
\end{itemize}
