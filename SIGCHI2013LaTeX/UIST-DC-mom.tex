...
Massive online courses, such as MOOCs, enable instructors to reach thousands of students at once. Some of the earliest MOOCs were programming and engineering classes, like Professor Ng's Machine Learning programming-based course and edX's Circuits and Electronics (6.002x) engineering course. Computer science and engineering education matters. In light of both the rise of MOOCs and the growth of computer science \cite{zweben2012computing}, computer science and engineering education is also getting larger in scale.
